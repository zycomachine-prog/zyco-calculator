...
const content = {
  ...
  tr: {
    ...
    relatedLabels: { pressBrakeCalculator: 'Abkant pres hesaplayıcısı', materialDatabase: 'Malzeme veritabanı', vDieSelectionTool: 'V kalıp seçim aracı', insideRadiusGuide: 'İç radyüs kılavuzu', springbackDatabase: 'Geri esneme veritabanı', bendAllowanceCalculator: 'Büküm payı hesaplayıcı', airBendingGuide: 'Havada büküm kılavuzu', pressBrakeTonnageGuide: 'Abkant pres tonaj kılavuzu', vDieOpeningGuide: 'V kalıp açıklığı seçimi', minimumFlangeLengthGuide: 'Minimum Flanş Boyu Kılavuzu', toolingSelectionGuide: 'Abkant pres takım seçimi kılavuzu', crowningGuide: 'Abkant pres sehim kompanzasyonu kılavuzu', stainlessSteelBendingGuide: 'Paslanmaz çelik büküm kılavuzu', aluminumBendingGuide: 'Alüminyum Büküm Kılavuzu' },
    ...
    <>
      <style>
        {`
          ...
          .zyco-stainless__back, .zyco-stainless__tool { display:inline-flex; align-items:center; justify-content:center; box-sizing:border-box; text-decoration:none; color:#fff; font-size:15px; font-weight:800; transition:transform .24s ease,box-shadow .24s ease,border-color .24s ease; }
          ...
          .zyco-stainless__back:hover, .zyco-stainless__tool:hover { transform:translateY(-2px); border-color:rgba(191,219,254,.72); color:#fff; }
          ...
          .zyco-stainless__tool:hover { box-shadow:0 18px 38px rgba(37,99,235,.42); }

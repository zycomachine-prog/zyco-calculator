...
const content = {
  en: {
    ...
    sections: [
      ...
      ['tooling', 'Tooling Selection for Stainless Steel', 'Stainless steel generally exhibits greater springback than mild steel. To assist with angle compensation, many fabricators prefer 80°-82° punches and dies rather than standard-angle tooling. Acute-angle tooling can help reduce springback-related angle variation and improve consistency, but tooling selection should always be confirmed according to material grade, thickness, bend radius and production requirements.'],
  ...
  zh: {
    ...
    sections: [
      ...
      ['tooling', '不锈钢模具选择', '不锈钢通常比低碳钢具有更大的回弹。为了辅助角度补偿，许多制造商会优先选择 80°-82° 的冲头和模具，而不是标准角度模具。锐角模具可帮助减少与回弹相关的角度波动并提高一致性，但模具选择仍应始终根据材料牌号、板厚、折弯半径和生产要求进行确认。'],

...
const routePath = '/springback-compensation-guide'
...
const content = {
  ...
  zh: {
    ...
    production: { title: '真实折弯生产建议', items: ['按牌号、炉批或卷批、板厚、纹向、V 开口、冲头半径、折弯方式和设备记录验证后的修正量。', '换卷或换批后重新核对；同一材料牌号的不同批次也可能需要重新校正。', '精密折弯必须在投产前进行实测试折，并在换模或设备维护后复核。', 'CNC 回弹修正不是输入一个固定数值，而是结合材料、模具、设备响应与检测结果持续校正。', '出现角度偏差时还应检查模具磨损、V 开口和设备挠度，不能只增加过弯量。'] },
    faqTitle: '常见问题',
    ...
    relatedLabels: { pressBrakeCalculator: '折弯机计算器', bendAllowanceCalculator: '折弯展开计算器', materialDatabase: '材料数据库', springbackDatabase: '回弹数据库', springbackCompensationGuide: '回弹补偿指南', vDieSelectionTool: 'V 型模具选择工具', insideRadiusGuide: '内半径指南', airBendingGuide: '空气折弯指南', pressBrakeTonnageGuide: '折弯机吨位指南', vDieOpeningGuide: 'V 开口指南', toolingSelectionGuide: '模具选型指南', crowningGuide: '挠度补偿指南', stainlessSteelBendingGuide: '不锈钢折弯指南', aluminumBendingGuide: '铝板折弯指南', minimumFlangeLengthGuide: '最小翻边指南', bendDeductionGuide: '折弯扣除量指南', kFactorGuide: 'K 因子指南' },
  },
  ru: {
  ...
  tr: {
    ...
    production: { title: 'Gerçek abkant üretimi için öneriler', items: ['Doğrulanan düzeltmeyi kalite, parti, kalınlık, hadde yönü, V açıklığı, zımba radyüsü, yöntem ve makineyle birlikte kaydedin.', 'Rulo veya parti değişiminde ayarı yeniden kontrol edin; aynı kalite adı farklı büküm davranışı gösterebilir.', 'Hassas bükümlerde seri öncesi ölçülen deneme bükümü ve takım değişimi sonrası tekrar doğrulama zorunludur.', 'CNC geri esneme düzeltmesi sabit sayı girmek değil; malzeme, takım, makine ve ölçüm sonucuyla yinelenen bir süreçtir.', 'Açı sapmasında yalnızca aşırı bükümü artırmak yerine takım aşınması, V açıklığı ve makine sehmini inceleyin.'] },
  ...
  return (
    <>
      <style>{`
        ...
        .zyco-comp__back,.zyco-comp__tool { display:inline-flex; align-items:center; justify-content:center; box-sizing:border-box; text-decoration:none; font-size:15px; font-weight:800; transition:transform .24s ease,box-shadow .24s ease,border-color .24s ease,color .24s ease; }
        ...
        .zyco-comp__back:hover,.zyco-comp__tool:hover { transform:translateY(-2px); border-color:rgba(191,219,254,.72); color:#fff; }
        .zyco-comp__tool:hover { box-shadow:0 18px 38px rgba(37,99,235,.42); }

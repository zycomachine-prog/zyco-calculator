...
relatedTools.en.bendSequenceGuide = 'Bend Sequence Guide'
relatedTools.zh.bendSequenceGuide = '折弯顺序指南'
relatedTools.ru.bendSequenceGuide = 'Руководство по последовательности гибки'
relatedTools.es.bendSequenceGuide = 'Guía de secuencia de plegado'
relatedTools.tr.bendSequenceGuide = 'Büküm Sırası Kılavuzu'
relatedTools.id.bendSequenceGuide = 'Panduan Urutan Bending'
...
relatedTools.en.kFactorGuide = 'K-Factor Guide'
relatedTools.zh.kFactorGuide = 'K 因子指南'
relatedTools.ru.kFactorGuide = 'Руководство по K-фактору'
relatedTools.es.kFactorGuide = 'Guía del factor K'
relatedTools.tr.kFactorGuide = 'K-Faktörü Kılavuzu'
relatedTools.id.kFactorGuide = 'Panduan K-Factor'
  ...
  en: {
    hub: {
      ...
      tools: [
        ...
        ['kFactorGuide', 'Neutral axis, K-factor calibration and accurate flat pattern engineering guide'],
        ...
        ['bendSequenceGuide', 'Plan press brake bending order to avoid tooling interference, part collision, accumulated angle error and production rework'],
  ...
  zh: {
    hub: {
      ...
      tools: [
        ...
        ['kFactorGuide', '用于中性层定位、K 因子校准与精确展开尺寸控制的工程指南'],
        ...
        ['bendSequenceGuide', '学习如何规划折弯顺序，避免模具干涉、工件碰撞、角度误差累积和生产返工'],
  ...
  ru: {
    hub: {
      ...
      tools: [
        ...
        ['kFactorGuide', 'Руководство по нейтральному слою, калибровке K-фактора и точной развертке'],
        ...
        ['bendSequenceGuide', 'Планирование порядка гибки для исключения помех оснастки, столкновений, накопления ошибок угла и переделки'],
  ...
  es: {
    hub: {
      ...
      tools: [
        ...
        ['kFactorGuide', 'Guía técnica del eje neutro, calibración del factor K y patrón plano preciso'],
        ...
        ['bendSequenceGuide', 'Planificación del orden de plegado para evitar interferencias, colisiones, error angular acumulado y retrabajo'],
  ...
  tr: {
    hub: {
      ...
      tools: [
        ...
        ['kFactorGuide', 'Nötr eksen, K-faktörü kalibrasyonu ve hassas açınım için mühendislik kılavuzu'],
        ...
        ['bendSequenceGuide', 'Takım girişimi, parça çarpışması, birikmiş açı hatası ve yeniden işlemi önlemek için büküm sırası planlama'],
  ...
  id: {
    hub: {
      ...
      tools: [
        ...
        ['kFactorGuide', 'Panduan teknis sumbu netral, kalibrasi K-factor, dan flat pattern akurat'],
        ...
        ['bendSequenceGuide', 'Merencanakan urutan bending untuk mencegah interferensi tooling, tabrakan komponen, akumulasi error sudut, dan rework'],
...
const airBendingPageTranslations = {
  ...
  zh: {
    ...
    motionDiagram: {
      ...
      title: '空气折弯过程：成形但不压底',
      intro:
        '空气折弯时，板料主要由 V 模两侧肩部支撑，通过上模下压形成折弯角度。工件不会完全压死在下模底部，因此最终角度会受到上模下压深度、V 开口、材料特性以及回弹补偿的共同影响。',
      punchStroke: '冲头行程',
      sheetBending: '板料弯曲',
      ...
      svgTitle: '空气折弯过程动态图示',
      svgDescription:
        '动态图示展示上模下压、板料由 V 模肩部支撑而弯曲且不压底，并显示自然内 R 角以及卸载后的轻微回弹。',
    },
    overview: [
  ...
  ru: {
    ...
    motionDiagram: {
      eyebrow: 'Анимация процесса',
      title: 'Воздушная гибка: формирование без дожима в дно',
      intro:
        'При воздушной гибке лист опирается на плечи V-матрицы, а пуансон формирует угол без полного дожима в дно. Итоговый угол зависит от глубины хода пуансона, раскрытия V-матрицы, свойств материала и компенсации пружинения.',
      punchStroke: 'Ход пуансона',
      sheetBending: 'Гибка листа',
      springbackReference: 'Ориентир пружинения',
      punch: 'Пуансон',
      sheetMetal: 'Листовой металл',
      vDie: 'V-матрица',
      vDieShoulders: 'Плечи V-матрицы',
      airBending: 'Воздушная гибка',
      insideRadius: 'Внутренний радиус',
      springback: 'Пружинение',
      noBottoming: 'Без дожима в дно',
      punchDownstroke: 'Ход пуансона вниз',
      highlightsAria: 'Ключевые элементы схемы',
      svgTitle: 'Анимированная схема воздушной гибки',
      svgDescription:
        'SVG-анимация показывает движение пуансона, гибку листа на плечах V-матрицы без дожима в дно, образование внутреннего радиуса и небольшое пружинение после разгрузки.',
    },
    overview: [
  ...
  es: {
    ...
    motionDiagram: {
      eyebrow: 'Animación del proceso',
      title: 'Plegado al aire: conformado sin tocar el fondo',
      intro:
        'En el plegado al aire, la chapa se apoya en los hombros de la matriz V mientras el punzón forma el ángulo. Como el material no llega a apoyar completamente en el fondo, el ángulo final depende de la penetración del punzón, la abertura V, el comportamiento del material y la compensación del retorno elástico.',
      punchStroke: 'Carrera del punzón',
      sheetBending: 'Plegado de chapa',
      springbackReference: 'Referencia de retorno elástico',
      punch: 'Punzón',
      sheetMetal: 'Chapa',
      vDie: 'Matriz V',
      vDieShoulders: 'Hombros de la matriz V',
      airBending: 'Plegado al aire',
      insideRadius: 'Radio interior',
      springback: 'Retorno elástico',
      noBottoming: 'Sin tocar el fondo',
      punchDownstroke: 'Descenso del punzón',
      highlightsAria: 'Puntos clave del diagrama',
      svgTitle: 'Diagrama animado del proceso de plegado al aire',
      svgDescription:
        'SVG animado que muestra el descenso del punzón, la chapa apoyada en los hombros de la matriz V sin tocar el fondo, la formación del radio interior y el ligero retorno tras descargar.',
    },
    overview: [
  ...
  tr: {
    ...
    motionDiagram: {
      eyebrow: 'Proses animasyonu',
      title: 'Havada büküm süreci: tabana oturtmadan şekillendirme',
      intro:
        'Havada bükmede sac, V kalıp omuzları üzerinde desteklenirken zımba açıyı oluşturur. Sac kalıp tabanına tam olarak oturmaz; son açı zımba dalma derinliği, V açıklığı, malzeme davranışı ve geri esneme telafisine bağlıdır.',
      punchStroke: 'Zımba stroku',
      sheetBending: 'Sac bükme',
      springbackReference: 'Geri esneme referansı',
      punch: 'Zımba',
      sheetMetal: 'Sac metal',
      vDie: 'V kalıp',
      vDieShoulders: 'V kalıp omuzları',
      airBending: 'Havada büküm',
      insideRadius: 'İç yarıçap',
      springback: 'Geri esneme',
      noBottoming: 'Tabana oturma yok',
      punchDownstroke: 'Zımba aşağı hareketi',
      highlightsAria: 'Diyagram vurguları',
      svgTitle: 'Havada büküm süreci animasyonu',
      svgDescription:
        'Animasyonlu SVG; zımbanın inişini, sacın V kalıp omuzlarında tabana oturmadan bükülmesini, doğal iç yarıçapı ve boşaltma sonrası hafif geri esnemeyi gösterir.',
    },
    overview: [
  ...
  id: {
    ...
    motionDiagram: {
      eyebrow: 'Animasi proses',
      title: 'Proses air bending: membentuk tanpa menyentuh dasar',
      intro:
        'Pada air bending, lembaran ditumpu oleh bahu V-die saat punch membentuk sudut. Material tidak ditekan penuh hingga dasar die, sehingga sudut akhir dipengaruhi kedalaman punch, bukaan V, perilaku material, dan kompensasi springback.',
      ...
      sheetMetal: 'Lembaran',
      vDie: 'V-die',
      vDieShoulders: 'Bahu V-die',
      airBending: 'Air bending',
      insideRadius: 'Radius dalam',
      springback: 'Springback',
      noBottoming: 'Tidak menyentuh dasar',
      punchDownstroke: 'Punch bergerak turun',
      highlightsAria: 'Sorotan diagram',
      svgTitle: 'Diagram animasi proses air bending',
      svgDescription:
        'SVG animasi yang menampilkan punch turun, lembaran menekuk di atas bahu V-die tanpa menyentuh dasar, terbentuknya radius dalam, serta sedikit springback setelah beban dilepas.',
    },
    overview: [
...
const bottomingVsCoiningPageTranslations = {
  en: {
    ...
    motion: {
      ...
      coining: { title: 'Coining', force: 'High Tonnage / imprinting', contact: 'Plastic Deformation', springback: 'Minimal Springback', radius: 'Sharp Inside R', pressNote: 'Coining is commonly performed on high-tonnage hydraulic press.' },
    },
  ...
  id: {
    ...
    motion: { title: 'Perbandingan Proses Animasi', intro: 'Stroke tersinkron menunjukkan tekukan menggantung, kontak seated, dan imprint lokal. Label springback hanya muncul ketika unloading.', svgTitle: 'Perbandingan industri Air Bending Bottoming dan Coining', svgDescription: 'Tiga diagram SVG sinkron dengan plat solid, punch, V-die, kontak pembentukan dan unloading.', air: { title: 'Air Bending', force: 'Gaya terendah / tiga kontak', contact: 'Tidak bottoming', springback: 'Springback', radius: 'Radius alami' }, bottoming: { title: 'Bottoming', force: 'Gaya lebih tinggi / seated', contact: 'Kontak die lebih banyak', springback: 'Springback berkurang', radius: 'Radius terkontrol' }, coining: { title: 'Coining', force: 'Tonase tinggi / imprint', contact: 'Deformasi plastis', springback: 'Springback minimal', radius: 'Radius kecil', pressNote: 'Coining umumnya dilakukan pada press hidrolik bertonase tinggi.' } },
